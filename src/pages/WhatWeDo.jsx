...
export default function WhatWeDo() {
    return (
      <>
        <Helmet>
          <title>What we do here | AP’IN</title>
        </Helmet>
        <Motion>
          <header>
            ...
            <div class="fluid-wrapper services-hero">
              ...
              <div class="content">
                <p class="default-paragraph">
                  There are lot of solutions that you can adopt in your company
                  or every day life to improve your ways of living. We help you
                  to prioritize your needs and find the best way to resolve your
                  challenge
                </p>
              </div>
            </div>
          ...
          <section class="sevices-list bg-dark">
            <div class="service--section__wrapper offset-canva">
              <div class="service--wrapper">
                ...
                <div class="services--details ">
                  <div class="description--title max-with_800">
                    <h3>
                      Enable the success of micro, small and medium size african
                      businesses by increasing their productivity and improving
                  ...
                  <div class="service-listing">
                    <div class="services-list">
                      <div class="service-list--title">
                        <h4>Enable the success of micro</h4>
                      </div>
                      <ul>
                ...
                <div class="service-listing__bottom d-flex">
                  <div class="description--title">
                    <h3>
                      Train yourself to acquire the relevent skills to take your
                  ...
                  <div class="services-list">
                    <p class="default-paragraph white-p">
                      We provide training services for personal growth and also
                      for professional goals no matter your level. You can
                      develop your digital skills to improve your own life
                      today.
                    </p>
                  </div>
                </div>
              ...
              <div class="service--wrapper">
                ...
                <div class="services--details ">
                  <div class="service-listing d-flex">
                    <div class="description--title">
                      <h3>
                        To conceive the platform of your dreams, you need
                        experts to lead you to your best.
                      </h3>
                    </div>
              ...
              <div class="service--wrapper">
                <div class="service--section__title">
                  <div class="section--title__box">
                    <h2 class="section--title">Branding and packaging</h2>
                  </div>
                </div>
                ...
                <div class="services--details ">
                  <div class="service-listing d-flex">
                    <div class="description--title">
                      <h3>Optimize the brand you have been dreaming of</h3>
                    </div>
                  ...
                  <div class="service-listing d-flex">
                    <div class="description--title">
                      <h3>
                        We provide the best of our service for the growth of
                        your project.
                      </h3>
                    </div>

                    <p class="default-paragraph white-p">
                      With regular feebacks, we adapt to the vision each service
                      we provide to our cusomer not matter were you are located
                      in the world.
                    </p>
                  </div>
                </div>
          ...
          <section class="service--banner">
            ...
            <div class="service--banner__footer">
              <div class="title">
                <h3>Ready to take you project to the next level</h3>
              </div>

              <div class="content">
                <p>
                  We put our strength together to provide best and excellent
                  services worldwide. We are convinced that our clients need to
                  be satisfied in all the aspect of our contract.
                </p>
              </div>
            </div>
          </section>
          ...
          <section class="get--start__section">
            <div class="section-wrapper">
              <div class="get--start__intro">
                <p>Let’s start something interesting together</p>
              </div>
              <div class="get--start__text">
                ...
                <a class="btn default-outline " href="start-with-us.php">
                  ...
                  Get start{" "}
                  <span>
                    <img class="icon-img" src={icons.arLight} alt="" />
                  </span>{" "}
                </a>
              </div>
            </div>
