        ...
        ===========================--> */}
            ...
            <section class="news--intro  offset-canva">
                ...
                <div class="others-news d-flex">
                    ...
                    <div class="others-news-item dflex" style={{ "--bg-img": `linear-gradient(to left, rgba(0,0,0, 0.5), rgba(0,0,0, 0.5)), url(${OthersImg1})` }}>
                    ...
                    <div class="others-news-item dflex" style={{ "--bg-img": `linear-gradient(to left, rgba(0,0,0, 0.5), rgba(0,0,0, 0.5)), url(${OthersImg2})` }}>
