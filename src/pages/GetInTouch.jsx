                ...
                <div className="contact--content">
                    ...
                    <div className="contact--bg offset-canva">
                        <div className="contact--footer__mail">
                            ...
                            <a className="contact--page__mail" href="mailto:hello@appealofinnovation.com">hello@appealofinnovation.com <span className="arrow"> <img src={icons.mailAr} alt="" /></span></a>
                        </div>
