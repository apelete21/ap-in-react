                ...
                <div className="about--intro offset-canva">
                    <div className="section--title__box">
                        <h2 className="section--title">
                            This is us <br />
                            we clear <span className="primary-color">focus</span>with <br /> results
                    ...
                    <div className="stats">
                        <div className="stat-box">
                            <span className="stats--number__sup">
                                Companies
                            </span>
                            <h3><span className="primary-color">35</span></h3>
                        </div>
                            ...
                            <div className="team-members">
                                <div className="team--member__card">
                                    ...
                                    <div className="desc">
                                        ...
                                        <p className="name">LARE-LAKTIEYI FeiKandine
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="team--member__card">
                                    ...
                                    <div className="desc">
                                        <span className="member--function"> Head of operations</span>
                                ...
                                <div className="team--member__card">
                                    ...
                                    <div className="desc">
                                        <span className="member--function"> Lead of online marketing </span>
                                ...
                                <div className="team--member__card flex--align__center">
                                    ...
                                    <div className="desc">
                                        <span className="member--function"> Lead of logistics</span>
                                ...
                                <div className="team--member__card flex--align__center">
                                    <img src={teams.Gladys} alt="" />
                                    <div className="desc">
                                        <span className="member--function"> Head of innovation </span>
                                        <p className="name">Jean-Philippe ABBEY</p>
                                    </div>
                                </div>
                                ...
                                <div className="team--member__card flex--align__end">
                                    ...
                                    <div className="desc">
                                        <span className="member--function"> Technical officer</span>
                ...
                <div className="section-wrapper">
                    ...
                    <div className="get--start__text">
                        ...
                        <a className="btn outline-red-btn " href="start-with-us.php"> learn more <span>
                            <img className={icons.arLight} alt="" /></span> </a>
                    </div>
                </div>
            </section>
        </div>
