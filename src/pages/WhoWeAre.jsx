    ...
    <Motion>
        ...
        <div className="fluid-wrapper about-us__hero ">
          ...
          <div className="main-description offset-canva">
            <p className="section--hero__desc">
              We are working on changing lives of today for a better futur. You
              can advantages of your strenghs and succeed your project with us
              on changing lives of today for
            </p>
          </div>
        </div>
        ...
        <div className="about--intro offset-canva">
          ...
          <div className="content">
            <p className="default-">
              ...
              Africa, America and Europe to make sure their projects are mooving
              as they desire. By our 3 awards the same year, we build the
              confidence on our abilities to solve problems
            </p>
          </div>
      ...
      <section className="our--goals offset-canva">
        ...
        <div className="our--goals__content">
          <p>
            Since september 2021, we have been working with companies in Africa,
            America and Europe to make sure their projects are
          </p>
        </div>
      ...
      <section className="get--start__section">
        <div className="section-wrapper">
          <div className="get--start__intro">
            <p>The transformation bigin with lives and at the perfect time.</p>
          </div>
