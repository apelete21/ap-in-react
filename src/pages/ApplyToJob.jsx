                ...
                <div class="upload-files-container">
                  <div class="drag-file-area">
                    ...
                    <label class="label">
                      ...
                      <span class="browse-files-text">click here </span>to
                      upload
                    </label>
                  </div>
                </div>
